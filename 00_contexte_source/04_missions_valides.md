...
- tests avant production : `[À compléter]` ;
- documentation ou procédure interne : `[À compléter]`.
...
- Documentation des points compris et des choix retenus : `[À compléter]`.

### Résultats obtenus

- Configuration Intune Android Enterprise préparée ou validée : `[À vérifier]`.
- Tablettes mieux standardisées : `[À vérifier]`.
- Sécurité renforcée par restrictions et mot de passe : `[À vérifier]`.
- Simplicité d'usage pour les utilisateurs : `[À vérifier]`.
...
L'objectif est de remplacer un registre visiteurs papier par une application utilisée sur tablette à l'entrée de l'entreprise.
...
- équipe informatique ;
- utilisateurs ou service d'accueil concernés : `[À compléter]`.
...
Résultats attendus ou à confirmer :

- suppression du registre papier : `[À vérifier]` ;
- centralisation dans SharePoint ;
- signature obligatoire ;
- meilleure traçabilité ;
- automatisation fiable : `[À vérifier]`.

Ne pas inventer de date de mise en service, de nombre de visiteurs ou de validation définitive si ces éléments ne sont pas confirmés.
...
L'étudiant a participé à des analyses liées à la sécurité opérationnelle des comptes et des postes : phishing, connexions suspectes et verrouillage de comptes AD.
...
- cause identifiée sur certains cas : `[À vérifier]`.
